...
//               <Button className="btn-group"> Купить робуксы</Button>
//               <Button className="btn-group"> Бесплатно</Button>
//               <Button className="btn-group"> Мои Покупки</Button>
...
//         <ButtonGroup>
//           <Button className="btn-group2"> Купить робуксы</Button>
//           <Button className="btn-group"> Бесплатно</Button>
//           <Button className="btn-group"> Мои Покупки</Button>
//           <Button className="btn-group">
//             {" "}
